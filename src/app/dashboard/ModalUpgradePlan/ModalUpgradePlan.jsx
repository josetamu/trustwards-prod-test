                        ...
                        <div className="modalUpgradePlan__site__info">
                            <span className="modalUpgradePlan__site__tick">
                                <svg width="7" height="7" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M6 1L1 6L6 1ZM1 1L6 6L1 1Z" fill="#AEAEAE"/>
                                    <path d="M6 1L1 6M1 1L6 6" stroke="#AEAEAE" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </span>
