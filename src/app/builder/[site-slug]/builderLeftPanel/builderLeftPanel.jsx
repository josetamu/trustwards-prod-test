...
function BuilderLeftPanel() {
    ...
    const [selectedItem, setSelectedItem] = useState('div')
    ...
    const renderTreeItem = (item, level = 0) => {
        ...
        return (
            <div key={item.id} className="tree-item" style={{ paddingLeft: `${level * 16}px` }}>
                <div className={`tree-item-header ${isSelected ? 'selected' : ''} ${isChildOfSelected ? 'child-selected' : ''}`}>
                    {hasChildren && (
                        <button 
