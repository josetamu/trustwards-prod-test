            ...
            <div className="tw-builder__toolbar-icon tw-builder__toolbar-icon--layout">
                ...
                <div className="tw-builder__toolbar-dropdown">
                    <div className="tw-builder__toolbar-dropdown-column">
                        ...
                        <div onClick={createBlock} draggable onDragStart={(e) => handleDragStart(e, 'block')} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--block">
                        ...
                        <div onClick={createImage} draggable onDragStart={(e) => handleDragStart(e, 'image')} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--image">
                        ...
                        <div onClick={createDivider} draggable onDragStart={(e) => handleDragStart(e, 'divider')} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--divider">
            ...
            <div className="tw-builder__toolbar-icon tw-builder__toolbar-icon--texts">
                ...
                <div className="tw-builder__toolbar-dropdown">
                    <div className="tw-builder__toolbar-dropdown-column">
                        ...
                        <div onClick={createText} draggable onDragStart={(e) => handleDragStart(e, 'text')} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--text">
