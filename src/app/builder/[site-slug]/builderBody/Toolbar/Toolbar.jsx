            ...
            <div className="tw-builder__toolbar-icon tw-builder__toolbar-icon--layout">
                ...
                <div className="tw-builder__toolbar-dropdown">
                    <div className="tw-builder__toolbar-dropdown-column">
                        ...
                        <div onClick={createBlock} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--block">
                        ...
                        <div onClick={createImage} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--image">
                        ...
                        <div onClick={createDivider} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--divider">
            ...
            <div className="tw-builder__toolbar-icon tw-builder__toolbar-icon--texts">
                ...
                <div className="tw-builder__toolbar-dropdown">
                    <div className="tw-builder__toolbar-dropdown-column">
                        ...
                        <div onClick={createText} className="tw-builder__toolbar-dropdown-item tw-builder__toolbar-dropdown-item--text">
