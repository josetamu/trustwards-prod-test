...
export const blockGroupControls = {
    header: [
        { name: 'Tag', type: 'super-select', category: 'block', JSONProperty: 'tagName', placeholder: 'div'},
        { name: 'Display', type: 'super-select', category: 'display', cssProperty: 'display', placeholder: 'flex', default: 'flex'},
    ],
    body: [
        {
            label: 'Spacing',
...
export const Block = (node, nodeProps = {}, children, anchorAncestor = false) => {
    ...
    */
    ...
    const groupControls = blockGroupControls;
