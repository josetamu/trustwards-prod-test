...
export const homePages = [
    ...
    {
      name: 'Websites',
      icon: <svg className="sidebar__link__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
...
export const profilePages = [
...

    {
        name: 'Affiliate',
        icon: <svg className="user__link__svg dropdown__icon" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path className="user__link__path" d="M7.58268 4.08333C7.58268 5.372 6.53799 6.41667 5.24935 6.41667C3.96068 6.41667 2.91602 5.372 2.91602 4.08333C2.91602 2.79467 3.96068 1.75 5.24935 1.75C6.53799 1.75 7.58268 2.79467 7.58268 4.08333Z" stroke="currentColor" strokeWidth="1.3"/>
        <path className="user__link__path" d="M8.75 6.41667C10.0386 6.41667 11.0833 5.372 11.0833 4.08333C11.0833 2.79467 10.0386 1.75 8.75 1.75" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
        <path className="user__link__path" d="M6.41602 8.16602H4.08268C2.47185 8.16602 1.16602 9.47187 1.16602 11.0827C1.16602 11.727 1.68835 12.2493 2.33268 12.2493H8.16602C8.81037 12.2493 9.33268 11.727 9.33268 11.0827C9.33268 9.47187 8.02683 8.16602 6.41602 8.16602Z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>
        <path className="user__link__path" d="M9.91602 8.16602C11.5268 8.16602 12.8327 9.47187 12.8327 11.0827C12.8327 11.727 12.3104 12.2493 11.666 12.2493H10.791" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
...
export function Sidebar({ 
    ...
    return (
        <div className={`${isSidebarMobile ? 'sidebar__backdrop' : ''}`}>
            <div className={`${isSidebarOpen ? 'sidebar--open' : 'sidebar--closed'} ${isSidebarMobile && windowWidth < 767 ? 'sidebar--mobile' : ''}`}>
