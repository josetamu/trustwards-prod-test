...
export function ModalUser({onSave, user, setUser, setIsModalOpen, appearanceSettings, setAppearanceSettings, userSettings, setUserSettings, /* getAppearanceSettings */ openChangeModal, avatarColors, checkProfilePicture, profileStyle, allUserDataResource }) {
