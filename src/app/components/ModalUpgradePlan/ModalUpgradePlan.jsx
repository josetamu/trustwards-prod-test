        ...
        <div className="modal-upgrade-plan">
            <div className="modal-upgrade-plan__header">
                ...
                <div className="modal-upgrade-plan__sub">
                    <div className="modal-upgrade-plan__infoContainer">
                    ...
                    <div className="modal-upgrade-plan__yearly">
            ...
            <div className="modal-upgrade-plan__plans">
                <div className="modal-upgrade-plan__plan">
                    <span className="modal-upgrade-plan__plan__title">Free</span>
                    <span className="modal-upgrade-plan__price">0<span className="modal-upgrade-plan__currency">$</span></span>
                    <span className="modal-upgrade-plan__plan__nsites">3 free sites</span>
                    <span className="modal-upgrade-plan__plan__description">Per month, billed {yearly ? 'yearly' : 'monthly'}</span>
                </div>
                <div className="modal-upgrade-plan__plan">
                    <span className="modal-upgrade-plan__plan__title">Solo</span>
                    <span className="modal-upgrade-plan__price">{yearly ? '5' : '6'}<span className="modal-upgrade-plan__currency">$</span></span>
                    <span className="modal-upgrade-plan__plan__nsites">1 pro site</span>
                    <span className="modal-upgrade-plan__plan__description">Per month, billed {yearly ? 'yearly' : 'monthly'}</span>
                    <div className="modal-upgrade-plan__subscribe">
                        <span className="modal-upgrade-plan__subscribe__title">Subscribe</span>
                    </div>
                </div>
                <div className="modal-upgrade-plan__plan">
                    <span className="modal-upgrade-plan__plan__title">Scale</span>
                    <span className="modal-upgrade-plan__price">{yearly ? '15' : '18'}<span className="modal-upgrade-plan__currency">$</span></span>
                    <span className="modal-upgrade-plan__plan__nsites">5 pro sites</span>
                    <span className="modal-upgrade-plan__plan__description">Per month, billed {yearly ? 'yearly' : 'monthly'}</span>
                    <div className="modal-upgrade-plan__subscribe">
                        <span className="modal-upgrade-plan__subscribe__title">Subscribe</span>
                    </div>
                ...
                <div className="modal-upgrade-plan__plan">
                    <span className="modal-upgrade-plan__plan__title">Trustwards<span className="modal-upgrade-plan__plan__title--popular">Popular</span></span>
                    <span className="modal-upgrade-plan__price">{yearly ? '29' : '35'}<span className="modal-upgrade-plan__currency">$</span></span>
                    <span className="modal-upgrade-plan__plan__nsites"><span className="modal-upgrade-plan__plan__nsites--unlimited">Unlimited</span> pro sites</span>
                    <span className="modal-upgrade-plan__plan__description">Per month, billed {yearly ? 'yearly' : 'monthly'}</span>
                    <div className="modal-upgrade-plan__subscribe modal-upgrade-plan__subscribe--popular">
                        <span className="modal-upgrade-plan__subscribe__title modal-upgrade-plan__subscribe__title--popular">Subscribe</span>
                    </div>
                </div>
            </div>
            <div className="modal-upgrade-plan__divider"></div>
            <div className="modal-upgrade-plan__site">
                <span className="modal-upgrade-plan__site__title">Site</span>
                <div className="modal-upgrade-plan__site__infos">
                    <div className="modal-upgrade-plan__info__container">
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">12 pages</span>
                        </div>
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick">
                                <svg className='modal-upgrade-plan__tick__svg' width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">3 
                                <span className='modal-upgrade-plan__site__info__title--underline'
                        ...
                        <div className="modal-upgrade-plan__site__info">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">1000 visitors/month</span>
                        </div>        
                    </div>
                    <div className="modal-upgrade-plan__info__container">
                        <div className="modal-upgrade-plan__site__info">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">Unlimited pages</span>
                        </div>
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick">
                                <svg className='modal-upgrade-plan__tick__svg' width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">25 
                                <span className='modal-upgrade-plan__site__info__title--underline'
                        ...
                        <div className="modal-upgrade-plan__site__info">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">Unlimited visitors</span>
                        </div>    
                    </div>
                    <div className="modal-upgrade-plan__info__container">
                        <div className="modal-upgrade-plan__site__info">
                        ...
                        <div className="modal-upgrade-plan__site__info">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">50 
                                <span className='modal-upgrade-plan__site__info__title--underline'
                    ...
                    <div className="modal-upgrade-plan__info__container">
                        ...
                        <div className="modal-upgrade-plan__site__info">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">Unlimited scans</span>
                        </div>  
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick">
                                <svg className='modal-upgrade-plan__tick__svg' width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="modal-upgrade-plan__divider"></div>
            <div className="modal-upgrade-plan__site">
                <span className="modal-upgrade-plan__site__title">Builder</span>
                <div className="modal-upgrade-plan__site__infos">
                    <div className="modal-upgrade-plan__info__container">
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick">
                        ...
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick modal-upgrade-plan__site__info__title--noincluded">
                            ...
                            <span className="modal-upgrade-plan__site__info__title modal-upgrade-plan__site__info__title--noincluded">Acces to builder</span>
                        </div>    
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick modal-upgrade-plan__site__info__title--noincluded">
                                <svg width="7" height="7" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="modal-upgrade-plan__site__info__title modal-upgrade-plan__site__info__title--noincluded">
                                <span className='modal-upgrade-plan__site__info__title--underline'
                    ...
                    <div className="modal-upgrade-plan__info__container">
                        <div className="modal-upgrade-plan__site__info">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">All 
                                <span className='modal-upgrade-plan__site__info__title--underline'
                        ...
                        <div className="modal-upgrade-plan__site__info">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">Access to builder</span>
                        </div>  
                        <div className="modal-upgrade-plan__site__info">
                            <span className="modal-upgrade-plan__site__tick">
                                <svg className='modal-upgrade-plan__tick__svg' width="8" height="6" viewBox="0 0 8 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span className="modal-upgrade-plan__site__info__title">
                                <span className='modal-upgrade-plan__site__info__title--underline'
