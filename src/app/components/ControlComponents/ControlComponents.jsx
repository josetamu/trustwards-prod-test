...
export const DisplayControl = ({}) => {
    ...
    <div className="tw-builder__settings-setting">
        ...
        <div className="tw-builder__settings-actions">
            <button className={`tw-builder__settings-action tw-builder__settings-action--start ${selectedJustify === 'flex-start' ? 'tw-builder__settings-action--active' : ''}`} onClick={() => handleJustifyChange('flex-start')} onMouseEnter={() => handleMouseEnter('jstart')} onMouseLeave={handleMouseLeave}>
            ...
            <button className={`tw-builder__settings-action tw-builder__settings-action--end ${selectedJustify === 'flex-end' ? 'tw-builder__settings-action--active' : ''}`} onClick={() => handleJustifyChange('flex-end')} onMouseEnter={() => handleMouseEnter('jend')} onMouseLeave={handleMouseLeave}>
                <svg width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<> 
    ...
    <div className="tw-builder__settings-setting">
        ...
        <div className="tw-builder__settings-actions">
            ...
            <button className={`tw-builder__settings-action ${selectedAlign === 'center' ? 'tw-builder__settings-action--active' : ''}`} onClick={() => handleAlignChange('through')} onMouseEnter={() => handleMouseEnter('through')} onMouseLeave={handleMouseLeave}>
            ...
            <button className={`tw-builder__settings-action ${selectedAlign === 'flex-end' ? 'tw-builder__settings-action--active' : ''}`} onClick={() => handleAlignChange('underline')} onMouseEnter={() => handleMouseEnter('underline')} onMouseLeave={handleMouseLeave}>
