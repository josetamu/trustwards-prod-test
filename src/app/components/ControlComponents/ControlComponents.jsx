...
<div className="tw-builder__control-header">
    <span className="tw-builder__control-label">Box Shadow</span>
</div>
<div className="tw-builder__settings-setting">
    <span className="tw-builder__settings-subtitle">X</span>
    <input type="text" className="tw-builder__settings-input"/>
</div>
<div className="tw-builder__settings-setting">
    <span className="tw-builder__settings-subtitle">Y</span>
    <input type="text" className="tw-builder__settings-input"/>
</div>
<div className="tw-builder__settings-setting">
...
export const DividerMainControl = () => {
