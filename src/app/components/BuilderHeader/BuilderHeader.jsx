    ...
    return (
      <div className="tw-builder__header">
        <div className="tw-builder__header-settings">
          <div className="tw-builder__header-setting">
          ...
          <div className="tw-builder__header-controls">
            <div className="tw-builder__header-control" onClick={canUndo ? undo : null} style={{opacity: canUndo ? 1 : 0.5}}>
            ...
            <div className="tw-builder__header-control" onClick={canRedo ? redo : null} style={{opacity: canRedo ? 1 : 0.5}}>
              <svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
